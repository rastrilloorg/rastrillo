...
<div class="rst-page">
  ...
  <form class="rst-form" method="post" action="#a">
    <div class="rst-form-flow">
      ...
      <div class="rst-field"><label class="rst-field__label" for="v6">Title</label><input class="rst-input rst-input--primary" type="text" id="v6" name="v6"></div>
      <div class="rst-field"><label class="rst-field__label" for="v7">Code</label><input class="rst-input rst-input--short rst-input--primary" type="text" id="v7" name="v7"></div>
